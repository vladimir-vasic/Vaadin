	...
	<table>
		<tr>
			<td valign="top"><c:if test="${not empty param.login_error}">
				<font color="red"> Invalid user name or password, try again.<br /><br /></font>
				</c:if>
									...
									<td valign="top">
										<table border="0" cellspacing="0" cellpadding="4" width="40%">
											...
											<tr>
												...
												<td valign="top" align="left"><input type='text' id='username' size="30" maxlength="40" name='j_username'
											...
											<tr>
												...
												<td valign="top" align="left"><input type='password' name='j_password' size="30" maxlength="30"></td>
											</tr>
											<tr>
												<td></td>
